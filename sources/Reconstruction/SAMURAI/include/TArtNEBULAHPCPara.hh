...
public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const TArtNEBULAHPCPara& p){
    ...
    out << "T Calib: "    << p.fTCal   << std::endl;
    out << "T Offset: "   << p.fTOff   << std::endl;
    out << "Map of TDC: "   << p.fRIDFMap  << std::endl;
    out << std::endl;
    return out;
  }
