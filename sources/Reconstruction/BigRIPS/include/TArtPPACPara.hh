...
public:
  ...
  void SetTx1Map(Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_tx1.SetMap(dev,f,d,g,c);}
  void SetTx2Map(Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_tx2.SetMap(dev,f,d,g,c);}
  void SetTy1Map(Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_ty1.SetMap(dev,f,d,g,c);}
  void SetTy2Map(Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_ty2.SetMap(dev,f,d,g,c);}
  void SetTaMap (Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_ta.SetMap(dev,f,d,g,c);}
  void SetQx1Map(Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_qx1.SetMap(dev,f,d,g,c);}
  void SetQx2Map(Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_qx2.SetMap(dev,f,d,g,c);}
  void SetQy1Map(Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_qy1.SetMap(dev,f,d,g,c);}
  void SetQy2Map(Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_qy2.SetMap(dev,f,d,g,c);}
  void SetQaMap (Int_t dev, Int_t f, Int_t d, Int_t g, Int_t c){map_qa.SetMap(dev,f,d,g,c);}
