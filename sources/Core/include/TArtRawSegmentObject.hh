...
class TArtRawSegmentObject : public TNamed
{
 public: 
  ...
  virtual void PutTacquilaData(TArtRawTacquilaDataObject * indata){
    tacquila_data_array.push_back(indata);
    return;
  }
  virtual TArtRawTacquilaDataObject * GetTacquilaData(int nn){ 
    return tacquila_data_array[nn];
  }
  virtual int GetNumTacquilaData(){return tacquila_data_array.size();}
 ...
 protected:
  ...
  // array of tacquila data
  std::vector <TArtRawTacquilaDataObject*> tacquila_data_array;
